...
const COLOR_OPTIONS = ['#1976d2', '#4caf50', '#ff9800', '#f44336', '#9c27b0', '#00bcd4', '#795548', '#607d8b']
  ...
  useEffect(() => {
    if (editingKpi) {
      ...
      setForm({
        ...
        unit: '', display_order: '0', icon: '', color: '#1976d2', filter_status: '',
      })
    }
  }, [editingKpi, open])
