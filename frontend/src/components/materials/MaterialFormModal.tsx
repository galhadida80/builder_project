...
import { InventoryIcon, DescriptionIcon, CheckCircleIcon, CloudUploadIcon, PersonIcon } from '@/icons'
import { Box, Typography, Divider, MenuItem, TextField as MuiTextField, Chip, Checkbox, FormControlLabel } from '@/mui'
...
interface MaterialFormModalProps {
  ...
  saving: boolean
  editing: boolean
  formData: { name: string; templateId: string; manufacturer: string; modelNumber: string; quantity: string; unit: string; expectedDelivery: string; storageLocation: string; notes: string }
