...
export const mockEquipment: Equipment[] = [
  { id: '1', projectId: '1', name: 'Tower Crane TC-500', equipmentType: 'Heavy Machinery', manufacturer: 'Liebherr', modelNumber: 'TC-500', serialNumber: 'LH2024001', status: 'approved', createdAt: '2024-01-20T00:00:00Z', updatedAt: '2024-02-01T00:00:00Z', createdBy: mockUsers[1] },
  { id: '2', projectId: '1', name: 'Concrete Pump CP-200', equipmentType: 'Heavy Machinery', manufacturer: 'Putzmeister', modelNumber: 'CP-200', serialNumber: 'PM2024002', status: 'under_review', createdAt: '2024-02-05T00:00:00Z', updatedAt: '2024-02-10T00:00:00Z', createdBy: mockUsers[1] },
  { id: '3', projectId: '1', name: 'Passenger Hoist PH-100', equipmentType: 'Lifting Equipment', manufacturer: 'Alimak', modelNumber: 'PH-100', serialNumber: 'AL2024003', status: 'submitted', createdAt: '2024-02-15T00:00:00Z', updatedAt: '2024-02-15T00:00:00Z', createdBy: mockUsers[1] },
  { id: '4', projectId: '1', name: 'Generator 500KVA', equipmentType: 'Power Equipment', manufacturer: 'Caterpillar', modelNumber: 'G500', serialNumber: 'CAT2024004', status: 'draft', createdAt: '2024-02-20T00:00:00Z', updatedAt: '2024-02-20T00:00:00Z', createdBy: mockUsers[1] },
]

export const mockMaterials: Material[] = [
  { id: '1', projectId: '1', name: 'Reinforcement Steel B500', materialType: 'Structural', manufacturer: 'Israel Steel Ltd', unit: 'ton', quantity: 500, status: 'approved', expectedDelivery: '2024-02-01', createdAt: '2024-01-25T00:00:00Z', updatedAt: '2024-02-01T00:00:00Z', createdBy: mockUsers[1] },
  { id: '2', projectId: '1', name: 'Ready-Mix Concrete C30', materialType: 'Structural', manufacturer: 'Readymix Industries', unit: 'm3', quantity: 2000, status: 'approved', expectedDelivery: '2024-01-20', createdAt: '2024-01-18T00:00:00Z', updatedAt: '2024-01-20T00:00:00Z', createdBy: mockUsers[1] },
  { id: '3', projectId: '1', name: 'Aluminum Window Frames', materialType: 'Finishing', manufacturer: 'Aluminco', unit: 'unit', quantity: 400, status: 'submitted', expectedDelivery: '2024-04-01', createdAt: '2024-02-10T00:00:00Z', updatedAt: '2024-02-10T00:00:00Z', createdBy: mockUsers[1] },
  { id: '4', projectId: '1', name: 'Fire-Rated Doors', materialType: 'Safety', manufacturer: 'SafeDoor Ltd', unit: 'unit', quantity: 80, status: 'under_review', expectedDelivery: '2024-05-01', createdAt: '2024-02-15T00:00:00Z', updatedAt: '2024-02-18T00:00:00Z', createdBy: mockUsers[1] },
]
