            ...
            <DialogContent>
              ...
              <Box sx={{ mb: 3 }}>
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                  ...
                  <Typography>{selectedLog.user?.fullName}</Typography>
                </Box>
              </Box>
                    ...
                    <Box key={change.field} sx={{ bgcolor: 'grey.50', p: 1.5, borderRadius: 1, mb: 1 }}>
                      ...
                      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mt: 0.5 }}>
                        {change.old !== undefined && (
                          <Chip label={String(change.old)} size="small" sx={{ bgcolor: 'error.light', color: 'error.contrastText' }} />
                        )}
                        <SwapHorizIcon fontSize="small" color="action" />
                        {change.new !== undefined && (
                          <Chip label={String(change.new)} size="small" sx={{ bgcolor: 'success.light', color: 'success.contrastText' }} />
                        )}
                      </Box>
                    </Box>
                  ))}
