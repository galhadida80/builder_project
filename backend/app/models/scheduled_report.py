...
class ReportTemplate(Base):
    ...
    Supports AI-generated reports (weekly-ai, inspection-summary-ai, executive-summary-ai)
    and traditional reports (inspection-summary, approval-status, rfi-aging, compliance-audit).
    """
    ...
    report_type: Mapped[str] = mapped_column(String(50), nullable=False, comment="See ReportType enum in schemas for valid values")
...
class ScheduledReport(Base):
    """
    Scheduled report model for automated report generation and distribution.
