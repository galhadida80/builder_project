...
def render_approval_reminder_email(
    ...
    if alert_type == "reminder":
        ...
        detail = (
            f"The {type_label.lower()} approval for <strong>{submission_name}</strong> "
            f"has been pending for {pending_days} days. Please review and take action."
        )
    else:
        ...
        detail = (
            f"The {type_label.lower()} approval for <strong>{submission_name}</strong> "
            f"has been pending for {pending_days} days and requires immediate attention."
        )
    ...
    <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;">
      ...
      <div style="padding:24px;border:1px solid #e5e7eb;border-top:none;border-radius:0 0 8px 8px;">
        ...
        <p style="margin:0;font-size:13px;color:#6b7280;">Please log in to review and process this approval.</p>
      </div>
    </div>
    """
